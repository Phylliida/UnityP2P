...
namespace UnityP2P
{
    ...
    public class PeerClass : IDisposable
    {
        ...
        {
            Debug.Log(myId + " has failure " + error);
        }

        private void CurWebRtc_OnError(string obj)
        {
            Debug.Log(myId + " has error " + obj);
        }
        ...
        void ParseMessage(string message)
        {
            ...
            {
                Debug.LogError("failed to parse " + message + " with error " + e.Message + " " + e.StackTrace);
            }
        }
        ...
        void SendPing()
        {
            ...
            {
                Debug.Log("failed to send ping because: " + e.Message + " " + e.ToString());
            }
        }
